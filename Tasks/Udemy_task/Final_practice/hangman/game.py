...
from Tasks.Udemy_task.Final_practice.hangman.game_status import GameStatus
from Tasks.Udemy_task.Final_practice.hangman.invalid_operation_exception import InvalidOperationException
...
class Game:
    ...
    def generate_word(self):
        filename = "data\\SortedUkrWords.txt"
    ...
    def guess_letter(self, letter: str):
        ...
        if self.tries_counter == self.allowed_misses:
            raise InvalidOperationException(f"Exceeded the max misses number: {self.allowed_misses}")
